...
shot1 = {
        ...
        "output": {
            ...
            "potential_supply_chain_impact": [
                {
                    "Risk_cause": "Supply and Demand Risk",
                ...
                {
                    "Risk_cause": "Logistics and Transportation Risk",
...
shot2 = {
        ...
        "output": {
            ...
            "potential_supply_chain_impact": [
                {
                    "Risk_cause": "Operational and Labor Risk",
...
shot3 = {
        ...
        "output": {
            "id": "N5",
            "Risk_category": "Environmental and Natural Risk",
            "location": "Japan, Tohoku Region",
            "severity": "High",
            "potential_supply_chain_impact": [
                {
                    "Risk_cause": "Logistics and Transportation Risk",
                    "Impact": "Severe disruptions in transportation networks can hinder the movement of goods and materials."
                },
                {
                    "Risk_cause": "Operational and Labor Risk",
                    "Impact": "Damage to infrastructure may lead to temporary closures of manufacturing facilities."
                },
                {
                    "Risk_cause": "Supply and Demand Risk",
                    "Impact": "Interruptions in production can reduce the availability of goods, affecting global trade."
                }
            ],
